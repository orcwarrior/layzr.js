(function (global, factory) {
  ...
  var layzr = (function () {
      ...
      function setSource(node) {
          var attrSrcset = node.getAttribute(settings.srcset);
          var attrBg = node.getAttribute(settings.bg);
          ...
          instance.emit('src:after', node);[settings.normal, settings.retina, settings.srcset, settings.bg].forEach(function (attr) {
